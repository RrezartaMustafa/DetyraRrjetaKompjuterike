...
PORTI=9000
ServeriHost='RRjeta'
ServeriSocket=socket(AF_INET,SOCK_DGRAM)
...
def Printo():     
              try:
                  ...
                  ServeriSocket.sendto(tekstiPrapa.encode('utf-8'),adresa)
...
def Zanore():
              try:
                  ...
                  ServeriSocket.sendto(pergjigja.encode('utf-8'),adresa)
                  print('Pergjigja u dergua :) :)')
              except:
...
def IP():       
              try:
                 ...
                 ServeriSocket.sendto(b.encode('utf-8'),adresa)
                 print('Pergjigja u dergua :) :)')
              except:
                   print('Foni zanore ka ndalur, provoni perseri!')
...
def Emaili():   
              try:
                  ...
                  ServeriSocket.sendto(domeni.encode('utf-8'),adresa)
                  print('Pergjigja u dergua :) :)')
...
def Faktoriel():
              try:
                 ...
                 ServeriSocket.sendto(faktorieliFund.encode('utf-8'),adresa)
                 print('Pergjigja u dergua :) :)')
              except:
...
def Time():
              try:            
                  ...
                  ServeriSocket.sendto(koha.encode('utf-8'),adresa)
                  print('Pergjigja u dergua :) :)')
              except:
...
def Hosti():
              try:
                ...
                Pergjigja='Hosti i klientit �sht�:'+ServeriHost
                ServeriSocket.sendto(Pergjigja.encode('utf-8'),adresa)
                print('Pergjigja u dergua :) :)')
              except:
...
def Konverto1():
              try:
                 ...
                 ServeriSocket.sendto(Dergesa.encode('utf-8'),adresa)
                 print('Pergjigja u dergua :) :)')
              except:
              ...
              try:  
                ...
                for i in range(20):
                    ...
                    if(str(i)=='0'):
                      ...
                      keno=str(p)+','+keno
                ServeriSocket.sendto(keno.encode('utf-8'),adresa)
                print('Pergjigja u dergua :) :)')
              except:
...
def ditelindja():
               ...
               try:
                ...
                ServeriSocket.sendto(shfaq.encode('utf-8'),adresa)
                print('Pergjigja u dergua :) :)') 
...
def Lotaria():
               try:
                 ...
                 ServeriSocket.sendto(s.encode('utf-8'),adresa)
                 print('Pergjigja u dergua :) :)') 
                   ...
                   while p <= x:
                     for i in range(2, p):
                        if( p%i == 0):
                                ...
                                j=j+1
                   numriTotal=str(j)
                   ServeriSocket.sendto(numriTotal.encode('utf-8'),adresa)
                   print('Pergjigja u dergua :) :)')
                except:
...
def TEK():
                 try:
                  ...
                  ServeriSocket.sendto(numTek.encode('utf-8'),adresa)
                  print('Pergjigja u dergua :) :)')
                 except:
...
def Qyteti():
               try:  
                   ...
                   vendi='nuk kemi gjeur vendin tuaj'
                   pergj=str(b)
                   ...
                   ServeriSocket.sendto(vendi.encode('utf-8'),adresa)
                   print('Pergjigja u dergua :) :)')
...
while 1:
        Edhena,adresa=ServeriSocket.recvfrom(1024)
